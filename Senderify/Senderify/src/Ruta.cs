...
namespace Senderify.src
{
    internal class Ruta
    {
        ...
        public Ruta(string nombre, string inicio, string fin, string duracion, string distancia, string fecha, string hora, string dificultad, string guia, string n_excursionistas, string comida_bebida, string precio, string material, string pdi, string acceso_orig, string acceso_vuelta)
        {
            this.nombre = nombre;
            this.inicio = inicio;
            this.fin = fin;
